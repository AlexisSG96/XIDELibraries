...
bool ${isAddress}(void)
{
    return <#if (D_AREGISTER??)>!${D_AREGISTER}bits.D_A;</#if>
}
...
bool ${isRead}(void)
{
    return <#if (R_WREGISTER??)>${R_WREGISTER}bits.R_W;</#if>
}
...
{
    <#if (SCIEREGISTER??)>${SCIEREGISTER}bits.SCIE = 1;</#if>
}

void ${disableStartIRQ}(void)
{
    <#if (SCIEREGISTER??)>${SCIEREGISTER}bits.SCIE = 0;</#if>
}

void ${enableStopIRQ}(void)
{
    <#if (PCIEREGISTER??)>${PCIEREGISTER}bits.PCIE = 1;</#if>
}

void ${disableStopIRQ}(void)
{
    <#if (PCIEREGISTER??)>${PCIEREGISTER}bits.PCIE = 0;</#if>
}
...
<#if MASTERINTERRUPT??>
void __attribute__ ( ( interrupt, no_auto_psv ) ) ${MASTERINTERRUPT.handler_name} ( void )
{
    (*${Masteri2cISR})();
}
</#if>
<#if SLAVEINTERRUPT??>
void __attribute__ ( ( interrupt, no_auto_psv ) ) ${SLAVEINTERRUPT.handler_name} ( void )
{
    (*${Slavei2cISR})();
}
</#if>
<#if BUSCOLLISIONINTERRUPT??>
void __attribute__ ( ( interrupt, no_auto_psv ) ) ${BUSCOLLISIONINTERRUPT.handler_name} ( void )
{
    (*${busCollisionISR})();
}
</#if>