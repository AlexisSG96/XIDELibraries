...
<#if usesInterruptTMRGI>
<#if isVectoredGatedInterruptEnabled>
<#if gateHighPriorityInterrupt>
void __interrupt(irq(${interruptIRQGateName}),base(${IVTBaseAddress})) ${moduleNameUpperCase}_${GatedInterruptFunctionName}()
<#else>
void __interrupt(irq(${interruptIRQGateName}),base(${IVTBaseAddress}),low_priority) ${moduleNameUpperCase}_${GatedInterruptFunctionName}()
</#if>
<#else>
