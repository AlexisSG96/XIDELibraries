...
/**
  ...
  @Example
    ...
    bool gAppShutdown = false;
    {
      ...
      while(!${functionPrefix}${moduleNameUpperCase}_IsBandGapVoltageStable());
      while(1)
      {
         //Polling
...
/**
  ...
  <code>
      ...
      ${functionPrefix}${moduleNameUpperCase}_TripPointSetup(EXCEED_TRIP_POINT,
        ${moduleNameUpperCase}_TRIP_POINT_1p85v);
      //Enable the module
...
/**
  ...
  @Preconditions
    ...
    ${functionPrefix}${moduleNameUpperCase}_IsBandGapVoltageStable
    function should be called first.
