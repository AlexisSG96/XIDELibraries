...
/**
  @Summary
    Reads the 32-bit value of Capture register.

  @Description
    This function reads the 32-bit value of Capture register and return it.
  ...
  @Returns
    This function returns the 32-bit value of Capture Register.
  ...
  @Example
    ...
    uint32_t capvalue= ${moduleNameUpperCase}_ReadCaptureValue())
    // Do something else...
    // Stop ${moduleNameUpperCase};
     ${moduleNameUpperCase}_StopTimer();
    </code>
...
/**
  ...
  @Example
    ...
    // Read the current value of ${moduleNameUpperCase}
    uint32_t capvalue= ${moduleNameUpperCase}_CaptureOnCommand())
    // Do something else...
    // Stop ${moduleNameUpperCase};
     ${moduleNameUpperCase}_StopTimer();
    </code>
