...
/**
 * \brief ${moduleNameUpperCase} Interrupt Handler
 *        This is a pointer to the function that will be called upon ${moduleNameUpperCase} interrupt
 * \param[in] None
 *
 * \return Nothing
 */
...
/**
 * \brief Set ${moduleNameUpperCase} Interrupt Handler
 * This API sets the function to be called upon ${moduleNameUpperCase} interrupt
 * \param[in] None
 *
 * \return Nothing
 */
