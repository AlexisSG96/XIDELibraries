...
*/
<#if usesInterruptTXI>
extern void (*${moduleNameUpperCase}_${defaultInterruptTransmitHandlerFunctionName})(void);
</#if>
<#if usesInterruptRCI>
extern void (*${moduleNameUpperCase}_${defaultInterruptReceiveHandlerFunctionName})(void);
</#if>
