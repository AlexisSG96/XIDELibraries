...
void ${moduleNameUpperCase}_SetTxInterruptHandler(void (* interruptHandler)(void)){
    ${moduleNameUpperCase}_${defaultInterruptTransmitHandlerFunctionName} = interruptHandler;
}
</#if>

<#if usesInterruptRCI>
void ${moduleNameUpperCase}_SetRxInterruptHandler(void (* interruptHandler)(void)){
    ${moduleNameUpperCase}_${defaultInterruptReceiveHandlerFunctionName} = interruptHandler;
}
</#if>
/**
  End of File
