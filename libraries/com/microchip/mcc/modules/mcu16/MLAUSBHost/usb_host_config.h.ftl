...
#define NUM_TPL_ENTRIES ${NumTPLEntries}
#define USB_NUM_CONTROL_NAKS ${numControlNaks}
#define USB_SUPPORT_INTERRUPT_TRANSFERS
#define USB_NUM_INTERRUPT_NAKS ${numInterruptNaks}
#define USB_INITIAL_VBUS_CURRENT (${VbusCurrentOutput}/2)
#define USB_INSERT_TIME (${insertTime}+1)
