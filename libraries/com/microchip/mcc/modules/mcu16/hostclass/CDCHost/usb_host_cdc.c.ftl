...
*/
    ...
    #define USB_MAX_CDC_DEVICES        ${MaxNumCDC}
#endif
...
// Default values for RS232 configuration data
    ...
    #define USB_CDC_BAUDRATE_SUPPORTED ${BaudRate}L // default BAUDRATE for the device
#endif

#ifndef USB_CDC_PARITY_TYPE 
    #define USB_CDC_PARITY_TYPE ${ParityOutput}     // default Parity type
#endif

#ifndef USB_CDC_STOP_BITS 
    #define USB_CDC_STOP_BITS ${StopBits}           // default Stop bits
#endif

#ifndef USB_CDC_NO_OF_DATA_BITS 
    #define USB_CDC_NO_OF_DATA_BITS ${DataBits}     // default value of data width
#endif
...
/*******************************************************************************
  ...
  Description:
    ...
    application in file usb_host_config.h . In case application does not delcare the
  ...
  Precondition:
    Configuration macros should be defined in file usb_host_config.h. USBConfig tool
  ...
  Remarks:
    If the apllication does not define macros in file usb_host_config.h then default
