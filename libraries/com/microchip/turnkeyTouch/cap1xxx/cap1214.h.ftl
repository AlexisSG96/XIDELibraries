...
/*
 * Register Definitions For CAP1214
 */

#define CAP_PRODUCT_ID_ADDRESS  0xfd //CAP1214  ~~~~~~~ h
#define CAP_VENDOR_ID_ADDRESS   0xfe  // CAP1214 default 5Ah
#define CAP_REVISION_ADDRESS    0xff   // CAP1214 default 80h

#define PRODUCT_ID_CAP1214      0x5A
#define MANUFACTURER_ID_CAP1214 0x5d

#define CAP_MAX_SENSOR_NUM      14

    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Register: MAIN STATUS CONTROL               @       00h
...
#define CAP_SENSOR_ENABLE_ADDRESS 0x21
    ...
    /* Register: BUTTON CONFIGURATION   @   22h
    R/W
     * 
     * 
     */
#define CAP_BUTTON_CONFIGURATION_ADDRESS 0x22
    ...
    typedef union {
        ...
        struct
        {
            unsigned RPT_RATE_B : 4;
            unsigned MAX_DUR_B : 4;
        };
        unsigned value : 8;
...
#define MAX_DUR5600ms 0xa //Default set CS1- CS7 
...
#define M_PRESS560ms 0xf
    ...
    /* Register: GROUP CONFIGURATION REGISTER 2    @   24h
    R/W 
     */
#define CAP_GROUP_CONFIGURATION_2_ADDRESS 0x24
    ...
    /* Register: CALIBRATION ENABLE    @   25h
    R/W
    */
...
#define CAP_LID_CLOSURE_CONFIG_ADDRESS 0x2b
    ...
    /* Register: LID CLOSURE QUEUE CONTROL  @   2Ch
    R/W
    */
...
#define CAP_LID_CLOSURE_PATTERN_1_ADDRESS 0x2D
    ...
    /* Register: LID CLOSURE PATTERN 2   @   2Eh
    R/W
     */
...
#define CAP_CONFIGURATION_2_ADDRESS 0x40
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:  GROUPED SENSOR CHANNEL ENABLE  @   41h
     * R/W  
     */
...
#define CAP_SAMPLING_CHANNEL_SELECT_ADDRESS 0x4E
   ...
   //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /* Register:    SAMPLING CONFIGURATION @   4Fh
     * R/W  
     */
...
#define CAP_LED_STATUS_2_ADDRESS 0x61
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:    FEEDBACK CONFIGURATION @  62H
     * R W 
     */

#define CAP_FEEDBACK_CONFIGURATION_ADDRESS 0x62

    typedef union {

        struct
        {
            unsigned FDBK_FREQ: 5;
            unsigned FDBK_DUR: 3;
           
        };
        unsigned value : 8;
    } CAP_FEEDBACK_CONFIGURATIONbits_t;
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:    FEEDBACK CHANNEL CONFIGURATION 1 @63H
     * RW    
     */

#define CAP_FEEDBACK_CHANNEL_CONFIGURATION_1_ADDRESS 0x63
    ...
    typedef union {
        ...
        unsigned value : 8;
    } CAP_FEEDBACK_CHANNEL_CONFIGURATION_1bits_t;
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:    FEEDBACK CHANNEL CONFIGURATION 2 @64H
     * RW    
     */

#define CAP_FEEDBACK_CHANNEL_CONFIGURATION_2_ADDRESS 0x64
    ...
    typedef union {
        ...
        struct
        {
            unsigned CS8_FDBK: 1;
            unsigned CS9_FDBK: 1;
            unsigned CS10_FDBK: 1;
            unsigned CS11_FDBK: 1;
            unsigned CS12_FDBK: 1;
            unsigned CS13_FDBK: 1;
            unsigned CS14_FDBK: 1;
            unsigned : 1;
        };
        unsigned value : 8;
    } CAP_FEEDBACK_CHANNEL_CONFIGURATION_2bits_t;
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:    FEEDBACK ONE-SHOT 2 @65H
     * RW   
     */

#define CAP_FEEDBACK_ONE_SHOT_ADDRESS 0x64
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:    LED / GPIO DIRECTION  @70H
     * RW   
     */
...
#define CAP_GPIO_INPUT_ADDRESS 0x72
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:    LED OUTPUT CONTROL 1 @73H
     * RW   
     */
...
#define CAP_LED_OUTPUT_CONTROL_1_ADDRESS 0x73
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:    LED OUTPUT CONTROL 2 @74H
     * RW   
     */
...
#define CAP_LED_POLARITY_2_ADDRESS 0x76
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:  LINKED LED TRANSITION CONTROL 1 @   77h
     * R/W  
     */
...
#define CAP_LINKED_LED_TRANSITION_CONTROL_1_ADDRESS 0x77
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:  LINKED LED TRANSITION CONTROL 2 @   78h
     * R/W  
     */
...
#define CAP_LED_CONFIG_ADDRESS 0x88
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Register:  LED11 CONFIG  @   8Ah
     * R/W  
     */

#define CAP_LED11_CONFIG_ADDRESS 0x8A

    typedef union {

        struct
        {
            unsigned LED11_CLK : 3;
            unsigned VAR_PWM : 1;
            unsigned LED11_STEPS : 2;
            unsigned : 2;
        };
        unsigned value : 8;
    } CAP_LED11_CONFIGbits_t;
